...
<div class="min-h-screen flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative">
    <div class="sm:mx-auto sm:w-full sm:max-w-md">
        <div class="flex justify-center mb-2">
            <img src="<?php echo e(asset('assets/logo-no_text.png')); ?>" alt="Logo" class="h-20 w-auto logo-animate transition-transform duration-300">
        </div>
    ...
    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-md relative">
        <div class="login-card py-10 px-8 rounded-2xl">
            <a href="<?php echo e(route('login.microsoft', ['role' => 'admin'])); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\kakdin\resources\views/auth/login_admin.blade.php ENDPATH**/ ?>