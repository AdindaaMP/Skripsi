...
<body class="bg-gradient-to-br from-blue-50 to-indigo-100 min-h-screen font-sans">
    ...
    <header class="bg-white shadow-sm">
        <div class="container mx-auto px-4 py-4 flex justify-center items-center">
            <img src="<?php echo e(asset('assets/Logo_ITCC_Lanscape.png')); ?>" alt="Logo" class="h-16 w-auto">
        </div>
    </header>
                ...
                <div class="bg-white rounded-xl shadow-2xl hover:shadow-3xl transition-all duration-700 ease-out transform hover:-translate-y-6 border border-gray-100">
                    <div class="p-8 text-center relative">
                        ...
                        <div class="relative z-10">
                            <div class="mb-4">
                                <img src="<?php echo e(asset('assets/logo-no_text.png')); ?>" alt="Logo" class="w-16 h-16 mx-auto drop-shadow-lg transition-transform duration-500 ease-out hover:scale-110">
                            </div>
                            <h3 class="text-3xl font-bold text-gray-800 mb-8 transition-all duration-300 ease-out">Peserta</h3>
                            <a href="<?php echo e(route('login.microsoft', ['role' => 'user'])); ?>" 
                ...
                <div class="bg-white rounded-xl shadow-2xl hover:shadow-3xl transition-all duration-700 ease-out transform hover:-translate-y-6 border border-gray-100">
                    <div class="p-8 text-center relative">
                        ...
                        <div class="relative z-10">
                            ...
                            <a href="<?php echo e(route('login.microsoft', ['role' => 'trainer'])); ?>" 
                ...
                <div class="bg-white rounded-xl shadow-2xl hover:shadow-3xl transition-all duration-700 ease-out transform hover:-translate-y-6 border border-gray-100">
                    <div class="p-8 text-center relative">
                        ...
                        <div class="relative z-10">
                            ...
                            <a href="<?php echo e(route('login.microsoft', ['role' => 'proctor'])); ?>" 
...
<?php /**PATH C:\xampp\htdocs\kakdin\resources\views/welcome.blade.php ENDPATH**/ ?>