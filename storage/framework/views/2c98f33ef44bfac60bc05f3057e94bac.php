...
<div class="bg-white p-8 rounded-lg shadow-md max-w-7xl mx-auto">
    ...
    <div class="flex justify-between items-start mb-6">
        <div>
            <h1 class="text-3xl font-bold text-gray-800"><?php echo e($group->name); ?></h1>
            <p class="text-gray-600">
                Bagian dari kegiatan: 
                <a href="<?php echo e(route('admin.sertifikasi.show', $activity->id)); ?>" class="text-blue-500 hover:underline"><?php echo e($activity->name); ?></a>
            </p>
        </div>
        <a href="<?php echo e(route('admin.sertifikasi.show', $activity->id)); ?>" class="text-gray-500 hover:text-gray-800">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <div class="bg-gray-50 p-6 rounded-lg flex flex-col items-center justify-between">
            ...
            <a href="<?php echo e(route('admin.kuesioner.index', $group->id)); ?>" class="w-full text-center bg-gray-800 text-white mt-4 px-4 py-2 rounded-lg text-sm font-medium hover:bg-gray-700">
                Ubah Kuesioner
            </a>
            <?php if($group->program && $group->program_id): ?>
                <a href="<?php echo e(route('admin.program.questionnaires.index', $group->program_id)); ?>" class="w-full text-center bg-blue-600 text-white mt-2 px-4 py-2 rounded-lg text-sm font-medium hover:bg-blue-700">
                    Kelola Kuesioner <?php echo e($group->program->name); ?>
    ...
    <div class="bg-white p-6 rounded-lg border border-gray-200">
        <div class="flex justify-between items-center mb-4">
            ...
            <div class="flex items-center gap-4">
                <form method="GET" action="<?php echo e(url()->current()); ?>" class="flex gap-2">
                    <input type="text" name="search" placeholder="Cari nama, email, atau nim..." value="<?php echo e(request('search')); ?>" class="border px-3 py-1.5 rounded-lg text-sm w-64">
                    <button type="submit" class="bg-gray-200 px-4 py-1.5 rounded-lg text-sm font-semibold hover:bg-gray-300">Cari</button>
                </form>
                <a href="<?php echo e(route('admin.sertifikasi.groups.edit', ['sertifikasi' => $activity->id, 'group' => $group->id])); ?>" class="bg-yellow-500 text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-yellow-600">Ubah Kelompok</a>
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $participants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="border-b hover:bg-gray-50">
                            ...
                            <td class="py-3 px-4"><?php echo e($user->jurusan ?? '-'); ?></td>
                            <td class="py-3 px-4">
                            ...
                            <td class="py-3 px-4 text-center">
                                <form action="<?php echo e(route('admin.groups.removeUser', ['group' => $group->id, 'user' => $user->id])); ?>" method="POST" onsubmit="return confirm('Yakin ingin menghapus peserta ini dari kelompok?')">
                                    <?php echo csrf_field(); ?>
                    ...
                    <?php endif; ?>
                    <?php $__currentLoopData = $invitedEmails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invite): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="border-b bg-yellow-50">
                            <td class="py-3 px-4"><?php echo e($invite->email); ?></td>
    ...
    <div class="relative top-20 mx-auto p-5 border w-full max-w-lg shadow-lg rounded-md bg-white">
        <div class="mt-3">
            ...
            <div class="mt-2 px-7 py-3">
                <form id="manual-invite-form" action="<?php echo e(route('admin.groups.inviteUser', $group->id)); ?>" method="POST" class="mb-4">
                    <?php echo csrf_field(); ?>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        if (submissionCtx) {
            new Chart(submissionCtx, {
                ...
                data: {
                    ...
                    datasets: [{
                        data: [
                            <?php echo e($pesertaSudahMengisi); ?>,
                            <?php echo e($trainerSudahMengisi); ?>,
                            <?php echo e($proctorSudahMengisi); ?>
        ...
        searchInput.addEventListener('keyup', function () {
            ...
            searchTimeout = setTimeout(() => {
                fetch(`<?php echo e(route('admin.users.search')); ?>?query=${query}&group_id=${groupId}`)
                        ...
                        if (users.length > 0) {
                            users.forEach(user => {
                                ...
                                userElement.innerHTML = `
                                    ...
                                    <form action="<?php echo e(route('admin.groups.addUser', $group->id)); ?>" method="POST">
                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\kakdin\resources\views/admin/training_groups/show.blade.php ENDPATH**/ ?>