...
<div class="bg-white p-8 rounded-lg shadow-md max-w-lg mx-auto">
    <h1 class="text-2xl font-bold text-gray-800 mb-6">Ubah Data Trainer</h1>
    ...
    <form action="{{ route('admin.trainer.update', $trainer->id) }}" method="POST">
        ...
        <div class="space-y-4">
            ...
            <div>
                ...
                <input type="text" name="avatar" id="avatar" value="{{ old('avatar', $trainer->avatar) }}" 
        ...
        <div class="flex justify-end gap-4 mt-6">
            <a href="{{ route('admin.trainer.show', $trainer->id) }}" class="bg-gray-200 text-gray-700 px-4 py-2 rounded-lg text-sm font-semibold hover:bg-gray-300">Batal</a>
